  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-all duration-500">
      ...
      <main className="container mx-auto px-4 pt-20">
        ...
        <section id="qibla" className="py-16">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
...
function IslamicCalendar() {
  ...
  const islamicEvents = [
    { date: "Dhu al-Hijjah 10", event: "Eid ul Adha", description: "Festival of Sacrifice" },
    { date: "Dhu al-Hijjah 8-13", event: "Hajj Period", description: "Pilgrimage to Mecca" },
    { date: "Dhu al-Hijjah 9", event: "Day of Arafah", description: "Day of Standing" },
    { date: "Ramadan 27", event: "Laylat al-Qadr", description: "Night of Power" },
    { date: "Shawwal 1", event: "Eid ul Fitr", description: "Festival of Breaking the Fast" },
  ]
      ...
      <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="text-center mb-6">
            ...
            <div className="text-lg text-gray-600 dark:text-gray-400">Approximately: Dhu al-Hijjah 1446 AH</div>
          </div>

          <div className="space-y-3">
            <h4 className="font-semibold text-gray-800 dark:text-white">Important Islamic Events:</h4>
            {islamicEvents.map((event, index) => (
              <div key={index} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <div className="font-medium text-emerald-600">{event.event}</div>
        ...
        <CardContent>
          <div className="space-y-4">
            {Object.entries(prayerTimes).map(([prayer, time]) => (
              ...
              >
                ...
                <div className="text-emerald-600 font-mono text-lg">{time}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
            <p className="text-sm text-emerald-800 dark:text-emerald-200">
              <strong>Note:</strong> Prayer times are approximate and may vary based on your location. Please consult
              your local mosque or Islamic center for accurate times.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <CardContent className="text-center">
        {!location.latitude ? (
          <div className="space-y-4">
            ...
            <Button onClick={getCurrentLocation} disabled={loading} className="bg-emerald-600 hover:bg-emerald-700">
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-emerald-600">{qiblaDirection?.toFixed(1)}°</div>
              <p className="text-gray-600 dark:text-gray-400 mt-2">From your current location</p>
            </div>

            {/* Compass */}
            <div className="relative w-48 h-48 mx-auto">
              <div className="absolute inset-0 border-4 border-gray-300 dark:border-gray-600 rounded-full"></div>
              <div className="absolute inset-4 border-2 border-gray-200 dark:border-gray-700 rounded-full"></div>
              ...
              <div
                className="absolute top-1/2 left-1/2 w-1 h-20 bg-emerald-600 transform -translate-x-1/2 origin-bottom"
                style={{
                  transform: `translate(-50%, -100%) rotate(${qiblaDirection}deg)`,
                  transformOrigin: "bottom center",
                }}
              >
                <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-2 border-r-2 border-b-4 border-transparent border-b-emerald-600"></div>
              </div>
        ...
        <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
          <p className="text-sm text-amber-800 dark:text-amber-200">
            <strong>Note:</strong> This is an approximate direction. For precise prayer direction, please consult your
            local mosque or use a physical compass for verification.
          </p>
        </div>
      </CardContent>
    </Card>
